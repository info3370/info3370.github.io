...
The [data](../assets/data/jencks_table1.csv) can be loaded from the course website with the line below.

```{r, comment = F, message = F}
data <- read_csv(file = "https://info3370.github.io/assets/data/jencks_table1.csv")
```
