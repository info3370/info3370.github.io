...
**2.2. (4 points)** Interpret your graph from (2.1) in up to three sentences. Comment particularly on how the facet for respondents who are in the higher professional class looks different from the others.
...
**2.6. (4 points)** Interpret your graph from (2.5) in up to three sentences.
